"""
Django settings for m2_test_rohit_saini project.
...
SECRET_KEY = 'django-insecure-v(ozuce(l10)f0eddj!-$r1+!&@1$!0%2i-as3@#-h^)n$)**d'
...
ROOT_URLCONF = 'm2_test_rohit_saini.urls'
...
WSGI_APPLICATION = 'm2_test_rohit_saini.wsgi.application'
